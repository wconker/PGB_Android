...
import com.android.pinggubang.Utils.MCrypt;
    ...
    public void Test(String url) {
        ...
        client.newCall(request2).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                com.android.pinggubang.Utils.Log.sys("_backForData" + "eeer");
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                com.android.pinggubang.Utils.Log.sys("_backForData" + Data2);
    ...
    public void send(File files, Map<String, String> params) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                com.android.pinggubang.Utils.Log.e("网络连接失败");
                call.cancel();
            }
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    //打印输出
                    com.android.pinggubang.Utils.Log.e("cmd=" + obj.get("cmd") + ";code=" + obj.get("code"));
                    int code = JSONUtils.getInt(obj, "code", 0);
                    if (code == 1111) {
