...
import com.android.pinggubang.Activity.Activity_Tool.Maptools;
import com.android.pinggubang.Activity.Activity_XJ.CreateXJ;
import com.android.pinggubang.Activity.Core.SelectCity;
import com.android.pinggubang.Activity.Core.SelectCompanyPeople;
...
import com.android.pinggubang.View.InnerListview.adapt.ChildAdapt;
...
public class CreateKC extends Activity implements ExChange.CallBackForData, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new CBarView(this, new CBarView.OnClickListener() {
            ...
            public void onLeftClick() {
                super.onLeftClick();
                new Dialog(CreateKC.this, "提示：", "放弃编辑并退出？", new Dialog.dialogButton() {
                    @Override
        ...
        try {
            switch (vid) {
                case R.id.chooseformap:
                    Intent intentForMap= new Intent(CreateKC.this, Maptools.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==MAPCODE)
        {
            ...
            bdw_et.setText(data.getStringExtra("addressText"));
        }
        if (resultCode == 260) {
