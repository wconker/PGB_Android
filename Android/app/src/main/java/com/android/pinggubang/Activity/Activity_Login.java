...
import com.android.pinggubang.Fragment.loginBypwd;
import com.android.pinggubang.Fragment.loginByyzm;
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 9999:
                    dialog.cancel();
                    com.android.pinggubang.Utils.Log.MyToast("账户不存在，请前往注册", Activity_Login.this);
                    break;
                case 99995:
                    com.android.pinggubang.Utils.Log.MyToast(ex.getMessageInfo(_str), Activity_Login.this);
                    dialog.cancel();
