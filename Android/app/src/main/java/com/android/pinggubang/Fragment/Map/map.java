package com.android.pinggubang.Fragment.Map;
...
import com.android.pinggubang.Bean.WZ;
    ...
    public BDLocationListener myListener = new BDLocationListener() {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            circleOptions.center(pianyi(location.getLongitude(), location.getLatitude())) //圆心
                    .radius(800)//半径 单位米
                    .fillColor(0x7fFFFFFF)//填充色
                    .stroke(new Stroke(2, 0xAA00FF00));//设置边框
...
//            map.addOverlay(option);
    ...
    private ExChange ex;
    private List<WZ> wzList = new ArrayList<>();
    ;
