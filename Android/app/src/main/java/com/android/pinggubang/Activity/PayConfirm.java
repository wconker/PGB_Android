...
import com.android.pinggubang.Fragment.XJ.MyXJList;
...
public class PayConfirm extends Activity implements ExChange.CallBackForData {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case PAYERROR:
                    com.android.pinggubang.Utils.Log.MyToast(ex.getMessageInfo(_pay), PayConfirm.this);
                    break;
                case ERROR:
                    com.android.pinggubang.Utils.Log.MyToast(ex.getMessageInfo(_add), PayConfirm.this);
                    break;
                case PAY:
                    try {
    ...
    public void onMessage(String str, String cmd, int code) {
        com.android.pinggubang.Utils.Log.e("报酬" + str);
        //发起支付
