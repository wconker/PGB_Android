...
import com.android.pgb.Activity.Activity_XJ.Activity_addBJ;
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == IMAGE_UP) {
                if (ImageCount == selectedPhotos.size()) {
                    com.android.pgb.Utils.Log.MyToast("提交成功", Activity_AddTb.this);
                    finish();
                }
            }
            if (msg.what == ERROR) {
                com.android.pgb.Utils.Log.MyToast(ex.getMessageInfo(_error), Activity_AddTb.this);
            }
            if (msg.what == 520) {
                JSONObject data;
                try {
                    ...
                    if (data.getInt("code") == 0) {
                        ...
                        com.android.pgb.Utils.Log.MyToast(ex.getMessageInfo(_addtb), Activity_AddTb.this);
                    }
        ...
        switch (v) {
            ...
            case R.id.add_btn:
                ...
                try {
                    ...
                    com.android.pgb.Utils.Log.MyToast("请检查信息", Activity_AddTb.this);
                }
                break;
        }
    }
